...
func (*sm2PrivateKeyImportOptsKeyImporter) KeyImport(raw interface{}, opts bccsp.KeyImportOpts) (bccsp.Key, error) {
	...
	lowLevelKey, err := utils.SM2DERToPrivateKey(der)
	if err != nil {
...
type sm2X509PublicKeyImportOptsKeyImporter struct {
	bccsp *CSP
}

func (ki *sm2X509PublicKeyImportOptsKeyImporter) KeyImport(raw interface{}, opts bccsp.KeyImportOpts) (bccsp.Key, error) {
