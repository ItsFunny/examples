...
type MSP interface {
	...
	GetDefaultSigningIdentity(channelName string) (SigningIdentity, error)
	GetSigningIdentityBySignatureCertType(signatureType string) (SigningIdentity, error)
...
type SigningIdentity interface {
	...
	// Sign the message
	Sign(channelName string, msg []byte) ([]byte, error)
