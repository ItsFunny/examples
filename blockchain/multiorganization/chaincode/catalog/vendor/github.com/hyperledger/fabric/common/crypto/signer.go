...
// NewSignatureHeader creates a SignatureHeader with the correct signing identity and a valid nonce
func (bs *SignatureHeaderCreator) NewSignatureHeader(channelName string) (*cb.SignatureHeader, error) {
	creator, err := bs.Serialize(channelName)
	if err != nil {
		return nil, err
	}
