...
const (
	...
	SM2X509Certificate = "SM2X509Certificate"
)
...
// X509PublicKeyImportOpts contains options for importing public keys from an x509 certificate
type SM2X509PublicKeyImportOpts struct {
	Temporary bool
}

// Algorithm returns the key importation algorithm identifier (to be used).
func (opts *SM2X509PublicKeyImportOpts) Algorithm() string {
	return SM2X509Certificate
}

// Ephemeral returns true if the key to generate has to be ephemeral,
// false otherwise.
func (opts *SM2X509PublicKeyImportOpts) Ephemeral() bool {
	return opts.Temporary
}