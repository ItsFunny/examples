...
func NewWithParams(securityLevel int, hashFamily string, keyStore bccsp.KeyStore) (bccsp.BCCSP, error) {
	...
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.SM3Opts{}), sm3Hasher)
	...
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.SM2P256KeyGenOpts{}), &sm2KeyGenerator{curve: sm2.P256Sm2()})
	...
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.SM2X509PublicKeyImportOpts{}), &sm2X509PublicKeyImportOptsKeyImporter{bccsp: swbccsp})
