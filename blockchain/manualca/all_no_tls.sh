...
# ecdsa
 mv /Users/joker/.fabric-ca-client/fabric-ca-client-config.yaml /Users/joker/.fabric-ca-client/fabric-ca-client-config-gm.yaml && \
 mv /Users/joker/.fabric-ca-client/fabric-ca-client-config-ecdsa.yaml /Users/joker/.fabric-ca-client/fabric-ca-client-config.yaml && \
fabric-ca-client-origin enroll -d -u http://admin:adminpw@0.0.0.0:4052  -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
fabric-ca-client-origin register -d --id.name orderer0.${DOMAIN} --id.secret order0pw --id.type order --id.attrs '"hf.Registrar.Roles=orderer,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' --id.attrs '"hf.IntermediateCA=true"' -u http://0.0.0.0:4052 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
fabric-ca-client-origin register -d --id.name orderer1.${DOMAIN} --id.secret order1pw --id.type order --id.attrs '"hf.Registrar.Roles=orderer,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' --id.attrs '"hf.IntermediateCA=true"' -u http://0.0.0.0:4052 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
fabric-ca-client-origin register -d --id.name orderer2.${DOMAIN} --id.secret order2pw --id.type order --id.attrs '"hf.Registrar.Roles=orderer,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' --id.attrs '"hf.IntermediateCA=true"' -u http://0.0.0.0:4052 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
fabric-ca-client-origin register -d --id.name orderer3.${DOMAIN} --id.secret order3pw --id.type order --id.attrs '"hf.Registrar.Roles=orderer,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' --id.attrs '"hf.IntermediateCA=true"' -u http://0.0.0.0:4052 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
fabric-ca-client-origin register -d --id.name orderer4.${DOMAIN} --id.secret order4pw --id.type order --id.attrs '"hf.Registrar.Roles=orderer,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' --id.attrs '"hf.IntermediateCA=true"' -u http://0.0.0.0:4052 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
fabric-ca-client-origin register -d --id.name peer1.${DOMAIN} --id.secret peer1pw --id.type peer --id.attrs '"hf.Registrar.Roles=peer,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true "' --id.attrs '"hf.IntermediateCA=true"' -u http://0.0.0.0:4052 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
fabric-ca-client-origin register -d --id.name peer2.${DOMAIN} --id.secret peer2pw --id.type peer --id.attrs '"hf.Registrar.Roles=peer,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true "' --id.attrs '"hf.IntermediateCA=true"' -u http://0.0.0.0:4052 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/caOrganizations/tls-ca/admin/msp  && \
...
# sm2
mv /Users/joker/.fabric-ca-client/fabric-ca-client-config.yaml /Users/joker/.fabric-ca-client/fabric-ca-client-config-ecdsa.yaml && \
mv /Users/joker/.fabric-ca-client/fabric-ca-client-config-gm.yaml /Users/joker/.fabric-ca-client/fabric-ca-client-config.yaml && \
fabric-ca-client enroll -d -u http://admin:adminpw@0.0.0.0:4053 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/msp  && \
...
fabric-ca-client enroll -d -u http://orderer0.${DOMAIN}:orderer0pw@0.0.0.0:4053  -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer0.${DOMAIN}/msp  && \
fabric-ca-client enroll -d -u http://orderer1.${DOMAIN}:orderer1pw@0.0.0.0:4053  -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer1.${DOMAIN}/msp  && \
fabric-ca-client enroll -d -u http://orderer2.${DOMAIN}:orderer2pw@0.0.0.0:4053  -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer2.${DOMAIN}/msp  && \
fabric-ca-client enroll -d -u http://orderer3.${DOMAIN}:orderer3pw@0.0.0.0:4053  -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer3.${DOMAIN}/msp  && \
fabric-ca-client enroll -d -u http://orderer4.${DOMAIN}:orderer4pw@0.0.0.0:4053  -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer4.${DOMAIN}/msp  && \
...
fabric-ca-client-origin enroll -d -u http://orderer0.${DOMAIN}:order0pw@0.0.0.0:4052 --enrollment.profile tls  --csr.hosts orderer0.${DOMAIN} -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer0.${DOMAIN}/tls  && \
fabric-ca-client-origin enroll -d -u http://orderer1.${DOMAIN}:order1pw@0.0.0.0:4052 --enrollment.profile tls  --csr.hosts orderer1.${DOMAIN} -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer1.${DOMAIN}/tls  && \
fabric-ca-client-origin enroll -d -u http://orderer2.${DOMAIN}:order2pw@0.0.0.0:4052 --enrollment.profile tls --csr.hosts orderer2.${DOMAIN} -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer2.${DOMAIN}/tls  && \
fabric-ca-client-origin enroll -d -u http://orderer3.${DOMAIN}:order3pw@0.0.0.0:4052 --enrollment.profile tls  --csr.hosts orderer3.${DOMAIN} -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer3.${DOMAIN}/tls  && \
fabric-ca-client-origin enroll -d -u http://orderer4.${DOMAIN}:order4pw@0.0.0.0:4052 --enrollment.profile tls  --csr.hosts orderer4.${DOMAIN} -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/orderers/orderer4.${DOMAIN}/tls  && \
set +x
...
# sm2
 mv /Users/joker/.fabric-ca-client/fabric-ca-client-config.yaml /Users/joker/.fabric-ca-client/fabric-ca-client-config-ecdsa.yaml && \
 mv /Users/joker/.fabric-ca-client/fabric-ca-client-config-gm.yaml /Users/joker/.fabric-ca-client/fabric-ca-client-config.yaml && \
fabric-ca-client enroll -d -u http://Admin@${DOMAIN}:adminpw@0.0.0.0:4053 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/ordererOrganizations/${DOMAIN}/users/Admin@${DOMAIN}/msp  && \
...
fabric-ca-client enroll -d -u http://admin:adminpw@0.0.0.0:4054 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/msp  && \
...
fabric-ca-client register -d --id.name peer1.${DOMAIN} --id.secret peer1pw --id.type peer --id.attrs '"hf.Registrar.Roles=peer,hf.IntermediateCA=true,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' -u http://0.0.0.0:4054 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/msp  && \
fabric-ca-client register -d --id.name peer2.${DOMAIN} --id.secret peer2pw --id.type peer --id.attrs '"hf.Registrar.Roles=peer,hf.IntermediateCA=true,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' -u http://0.0.0.0:4054 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/msp  && \
fabric-ca-client register -d --id.name Admin@${DOMAIN} --id.secret adminpw --id.type admin --id.attrs '"hf.Registrar.Roles=admin,hf.IntermediateCA=true,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' -u http://0.0.0.0:4054 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/msp  && \
fabric-ca-client register -d --id.name User0@${DOMAIN} --id.secret user0pw --id.type client -u http://0.0.0.0:4054 --id.attrs '"hf.Registrar.Roles=client,hf.IntermediateCA=true,hf.GenCRL=true,hf.Revoker=true,hf.AffiliationMgr=true"' -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/msp  && \

mkdir -p ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/peers/{peer1.${DOMAIN},peer2.${DOMAIN}} && \

fabric-ca-client enroll -d -u http://peer1.${DOMAIN}:peer1pw@0.0.0.0:4054 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/peers/peer1.${DOMAIN}/msp  && \
fabric-ca-client enroll -d -u http://peer2.${DOMAIN}:peer2pw@0.0.0.0:4054 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/peers/peer2.${DOMAIN}/msp  && \
fabric-ca-client enroll -d -u http://Admin@${DOMAIN}:adminpw@0.0.0.0:4054 -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/users/Admin@${DOMAIN}/msp  && \
...
# ecdsa
 ...
 mv /Users/joker/.fabric-ca-client/fabric-ca-client-config-ecdsa.yaml /Users/joker/.fabric-ca-client/fabric-ca-client-config.yaml && \
set -x
fabric-ca-client-origin enroll -d -u http://peer1.${DOMAIN}:peer1pw@0.0.0.0:4052 --enrollment.profile tls --csr.hosts peer1.${DOMAIN} -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/peers/peer1.${DOMAIN}/tls  && \
fabric-ca-client-origin enroll -d -u http://peer2.${DOMAIN}:peer2pw@0.0.0.0:4052 --enrollment.profile tls  --csr.hosts peer2.${DOMAIN} -M ${GOPATH}/src/${DIRECTORY_NAME}/crypto-config/peerOrganizations/${DOMAIN}/peers/peer2.${DOMAIN}/tls  && \
set +x
