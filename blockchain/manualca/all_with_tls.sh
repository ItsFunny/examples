...
# ecdsa
sudo mv /root/.fabric-ca-client/fabric-ca-client-config.yaml /root/.fabric-ca-client/fabric-ca-client-config-gm.yaml && \
sudo mv /root/.fabric-ca-client/fabric-ca-client-config-ecdsa.yaml /root/.fabric-ca-client/fabric-ca-client-config.yaml && \
...
# sm2
sudo mv /root/.fabric-ca-client/fabric-ca-client-config.yaml /root/.fabric-ca-client/fabric-ca-client-config-ecdsa.yaml && \
sudo mv /root/.fabric-ca-client/fabric-ca-client-config-gm.yaml /root/.fabric-ca-client/fabric-ca-client-config.yaml && \
